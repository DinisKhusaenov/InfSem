...
public class UserRepositoryJdbcImpl implements UsersRepository {
    ...
    private static final String SQL_INSERT_USERS = "insert into users(email, name, last_name, password) values (:email, :name, :lastName, :password)";
    ...
    public void saveUser(User user) {
        ...
        user.setId(Math.toIntExact(keyHolder.<Long>getKeyAs(Long.class)));
    }
